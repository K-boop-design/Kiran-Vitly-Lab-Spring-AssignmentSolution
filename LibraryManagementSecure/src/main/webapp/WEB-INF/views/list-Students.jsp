...
<body>
	...
	<div class="container">
		...
		<!-- Add a search form -->
			...
			<form action="/LibraryManagementSecure/students/search" class="form-inline">

				<!-- Add a button -->
				<a href="/LibraryManagementSecure/students/showFormForAdd"
				...
				<button type="submit" class="btn btn-success btn-sm mb-3">Search</button>
					<a href="/LibraryManagementSecure/logout" 
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/LibraryManagementSecure/students/showFormForUpdate?bookId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/LibraryManagementSecure/students/delete?bookId=${tempStudent.id}"
